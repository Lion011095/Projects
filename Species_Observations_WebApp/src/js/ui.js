...
function toggleLoading(isLoading) {
  ...
  var changeButton = document.querySelector("#btns");
  if (isLoading === true) {
    changeButton.innerHTML = '<i class="fas fa-hourglass-half"></i>Loading...';
    changeButton.disable = true;
  } else {
    changeButton.innerHTML = '<i class="fas fa-search"></i>Search';
